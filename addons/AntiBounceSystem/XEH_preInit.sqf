...
["ABS_minAngle", "SLIDER", ["Minimum angle to use manual unflip assistant", "0 means vehicle is perfectly upright, 90 means on the side, etc."], "Anti-Bounce System" ,[45, 90, 60, 0], 1] call CBA_Settings_fnc_init;
["ABS_perFrameKey", "LIST", ["Manual unflip key press mode (Hold mod is recommended)", "Hold mode fires every frame when the key is down, even if not in vehicle (waste of performance), but it looks better."], "Anti-Bounce System" ,[[true, false], ["Hold", "Tap"], 0], 0, {
